...
api.post('/save', (req, res) => {
    ...
    item.pricePerUnit = parseInt(req.body.pricePerUnit, 10)
    item.quantity = parseInt(req.body.quantity, 10)
    item.ratings = parseInt(req.body.ratings, 10)
    item.productAssurance = req.body.productAssurance
    item.manufactureddate=req.body.manufactureddate
